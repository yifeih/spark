...
class TaskMetrics private[spark] () extends Serializable {
  ...
  @transient private[spark] lazy val nameToAccums = LinkedHashMap(
    ...
    shuffleWrite.FILE_WRITE_TIME -> shuffleWriteMetrics._fileWriteTime,
    shuffleWrite.NUM_FILES_WRITTEN -> shuffleWriteMetrics._numFilesWritten,
    shuffleWrite.INDEX_FILE_WRITE_TIME -> shuffleWriteMetrics._indexFileWriteTime,
    shuffleWrite.STREAM_COPY_WRITE_TIME -> shuffleWriteMetrics._streamCopyWriteTime,
    shuffleWrite.CREATE_PARTITION_WRITER_TIME -> shuffleWriteMetrics._createPartitionWriterTime,
    shuffleWrite.CREATE_MAP_OUTPUT_WRITER_TIME -> shuffleWriteMetrics._createMapOutputWriterTime,
    shuffleWrite.STREAM_FILE_WRITE_TIME -> shuffleWriteMetrics._streamFileWriteTime,
